                      ...
                      <div className="row">
                        <div
                          ...
                          className={
                            this.state.collapse === 1
                              ? `col-lg-${colsize} col-md-12 mt-1 card-header shadow p-3  bg-${this.state.headerColor}  `
                        ...
                        >
                          <h3
                            className={
                              this.state.collapse === 1
                                ? `btn btn-block mb-0  text-${this.state.headerTextColor}`
                                : "btn btn-block mb-0 text-dark"
                            }
                          >
                            مرحله اول - نوع درخواست هزینه
                          </h3>
                        </div>
                        <div
                          style={{ borderRadius: 20, zIndex: 1 }}
